...
#define MAX 10000 // Проверить на всём отрезке MAX
...
int main ()
{
    ...
    static int mass[MAX] = {2, 3}; // Массив, который хранит в себе все найденные простые числа

    if (MAX >= 1000000)
    {
        mass[MAX/10]; // Если число слишком большое
    }
